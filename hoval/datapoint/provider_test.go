...
func TestLoadDatapointConfigFromCSV(t *testing.T) {
	t.Run("successful load with valid CSV", func(t *testing.T) {
		...
		maps, err := datapoint.NewCsvDatapointProviderFromFileName(testCSV)
	...
	t.Run("file not found error", func(t *testing.T) {
		maps, err := datapoint.NewCsvDatapointProviderFromFileName("nonexistent.csv")
		assert.Error(t, err)
		assert.Nil(t, maps)
	...
	t.Run("invalid CSV format", func(t *testing.T) {
		...
		maps, err := datapoint.NewCsvDatapointProviderFromFileName(testFile)
		assert.Error(t, err)
		assert.Nil(t, maps)
